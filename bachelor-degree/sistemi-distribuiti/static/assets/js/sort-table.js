 ...
 * @returns {Float}
 */
 sortTable.money = function(Cell) {
    return parseFloat(sortTable.stripTags(Cell.innerHTML).replaceAll('$', ''));
};
 ...
 * @returns {String}                   
 */                                    
 sortTable.cpdate = function(Cell) {  
    let str = sortTable.stripTags(Cell.innerHTML);
    let date = str.substring(6, 10) + str.substring(3, 5) + str.substring(0, 2) + str.substring(11);
    return date;
};
//END CODE FOR CPBANK
